...
This post records some examples of using Wget to download data from FTP sites.<img src='/figures/posts/head-pics/2015-12-wget-usage-DALLE-3.png' width=500>
