...
This post mainly introduces how to use `conda` and `venv` to manage Python environments.<br/><img src='/figures/posts/head-pics/2022-05-python-env-manage-by-DALLE-3.png' width=500>

The above figure is generated by DALL·E 3 with prompt: Photo of a computer screen displaying Python code with conda and venv commands highlighted. Stickers related to Python and environment management are visible on the laptop's exterior.
