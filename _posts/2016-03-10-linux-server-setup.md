...
This post documents some considerations during the installation of CentOS and provides instructions for post-installation setup, including software installation. It may be of reference value for creating a Linux research environment suitable for *atmospheric science*.<img src='/figures/posts/head-pics/2016-03-10-linux-server-setup-DALLE-3.png' width=500>
